<?php 
   ...
   $cmd = "source ~/local/env_cc/bin/activate; cd /home/webserver/movie_spider; scrapy parse --pipeline --spider=onlinemoviewatchs --callback=parse_item $url >> /tmp/crawler_movie.log";
   system($cmd);
